...
from godrick.communicator import MPIPairedCommunicator, MPICommunicatorProtocol, CommunicatorTransportType
...
def test_MPICommunicator():
    ...
    with open(configFile) as f:
        ...
        #print(data)
        #print(commDict["transport"])
        #print(CommunicatorTransportType.MPI.value)
        assert commDict["transport"] == CommunicatorTransportType.MPI.name
